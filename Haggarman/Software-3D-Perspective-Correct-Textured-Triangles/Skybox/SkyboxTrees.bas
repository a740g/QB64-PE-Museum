        ...
        If delta_x >= (1 / 2048) Then
            ...
            While col < draw_max_x
                ...
                If Screen_Z_Buffer(zbuf_index) = 0.0 Or tex_z < Screen_Z_Buffer(zbuf_index) Then
                    ...
                    If T1_options And T1_option_alpha_channel Then
                        a0 = _Alpha32(uv_f) * Area_2f + _Alpha32(uv_0_0) * Area_00 + _Alpha32(uv_1_1) * Area_11
                    Else
                        ' solid
                        a0 = 255
                    End If
