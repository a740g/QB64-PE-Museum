...
_TITLE "Helicopter Rescue - Practice"
...
SkyColor = 6
GrondColor = 173
OPEN "..\TXTFiles\DAYNIGHT.TXT" FOR INPUT AS #1
INPUT #1, DN$
CLOSE #1


IF DN$ = "DAY" THEN DayNight$ = "NIGHT": DayNightSwap$ = "DAY"
IF DN$ = "NIGHT" THEN DayNight$ = "DAY": DayNightSwap$ = "NIGHT"
...
'  BaseFuel = 0 '         Gallons
Ammo = 1200: BaseFuel = 125 '         Gallons
...
FOR xp# = -worldx# / 2 + (xc0# \ 100) * 100 TO worldx# / 2 + (xc0# \ 100) * 100 STEP griddensity
    FOR zp# = -worldz# / 2 + (zc0# \ 100) * 100 TO worldz# / 2 + (zc0# \ 100) * 100 STEP griddensity
        ...
        'qx# = 400 + schaalx# * pf# * Atn(horhoek#) * aanliggende#
        'aanliggende# = _Hypot(yp# - yc5#, zp# - zc5#)
        'qy# = 225 - schaaly# * pf# * Atn(verhoek#) * aanliggende#
    ...
    IF schietstatus(akn) = 1 THEN
        ...
        IF yk#(akn) < 10 THEN
            FOR ObjectNummer = 1 TO AantalObjecten
                ...
                IF d# < ObjectHitBall AND yk#(akn) < HithoogteOmax AND ObjectYesNo(ObjectNummer) = 1 THEN '       *************************************************************OBJECT RAAK
        ...
        IF gunkogelafstand# > maxkogelweg# OR yk#(akn) < 0 THEN
            ...
            ' EasterEgg2 = 1
            'score& = score& + 2000: _SndPlay Bonus6&
            'End If
...
'
IF status$ = "LANDED" AND afstand# < landingstolerantie# AND fuelwin = 1 THEN

    IF fuel# < fuelmax# THEN GOSUB fuelplus ELSE fuelwin = 0
    IF didammo = 0 THEN didammo = 1: Ammo = 1200
...
'If TypeObjecten Mod 2 = 0 And Int(xc0#) = 1313 And Int(zc0#) = 1313 And EasterEgg1 = 0 Then EasterEgg1 = 1: score& = score& + 500: _SndPlay Bonus5& '  1313 easteregg
...
'
min$ = LTRIM$(STR$(Bruto& \ 60))
sec$ = LTRIM$(STR$(Bruto& MOD 60))
...
waarde$ = "PRESS BUTTON": dx = 400: dy = 240: GOSUB PlaatsTekstCentered
...
'
IF INT(fuel#) <= 10 AND status$ <> "LANDED" THEN
...
IF INT(fuel#) > 10 THEN FuelWarned = 0
...
IF RecordDemo = 1 THEN
    ...
    IF KnipperREC < 20 THEN PUT (8, 44), rec(0), PSET
...
pulse:
'
Bruto& = Bruto& + 1 'Practiceseconden
...
IF score& > PlayerScore&(1) OR (score& = PlayerScore&(1) AND Bruto& < PlayerSeconds&(1)) OR (score& = PlayerScore&(1) AND Bruto& = PlayerSeconds&(1) AND FuelTotalUsed# < FuelTotal#(1)) THEN 'Plek 1:  1=P 2=1 3=2 4=3 5=4 6=5 7=6 8=7 9=8 10=9
    NewPos = 1
    ...
    GOSUB invoer
    FuelTotal#(1) = INT(FuelTotalUsed#): PlayerName$(1) = Phrase$: PlayerScore&(1) = score&: PlayerLevel(1) = RFileNr: PS$(1) = min$ + ":" + sec$: PlayerSeconds&(1) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(2) OR (score& = PlayerScore&(2) AND Bruto& < PlayerSeconds&(2)) OR (score& = PlayerScore&(2) AND Bruto& = PlayerSeconds&(2) AND FuelTotalUsed# < FuelTotal#(2)) THEN '                           Plek 2:  2=P 3=2 4=3 5=4 6=5 7=6 8=7 9=8 10=9
    NewPos = 2
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(2) = INT(FuelTotalUsed#): PlayerName$(2) = Phrase$: PlayerScore&(2) = score&: PlayerLevel(2) = RFileNr: PS$(2) = min$ + ":" + sec$: PlayerSeconds&(2) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(3) OR (score& = PlayerScore&(3) AND Bruto& < PlayerSeconds&(3)) OR (score& = PlayerScore&(3) AND Bruto& = PlayerSeconds&(3) AND FuelTotalUsed# < FuelTotal#(3)) THEN '                           Plek 3:  3=P 4=3 5=4 6=5 7=6 8=7 9=8 10=9
    NewPos = 3
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(3) = INT(FuelTotalUsed#): PlayerName$(3) = Phrase$: PlayerScore&(3) = score&: PlayerLevel(3) = RFileNr: PS$(3) = min$ + ":" + sec$: PlayerSeconds&(3) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(4) OR (score& = PlayerScore&(4) AND Bruto& < PlayerSeconds&(4)) OR (score& = PlayerScore&(4) AND Bruto& = PlayerSeconds&(4) AND FuelTotalUsed# < FuelTotal#(4)) THEN '                           Plek 4:  4=P 5=4 6=5 7=6 8=7 9=8 10=9
    NewPos = 4
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(4) = INT(FuelTotalUsed#): PlayerName$(4) = Phrase$: PlayerScore&(4) = score&: PlayerLevel(4) = RFileNr: PS$(4) = min$ + ":" + sec$: PlayerSeconds&(4) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(5) OR (score& = PlayerScore&(5) AND Bruto& < PlayerSeconds&(5)) OR (score& = PlayerScore&(5) AND Bruto& = PlayerSeconds&(5) AND FuelTotalUsed# < FuelTotal#(5)) THEN '                           Plek 5:  5=P 6=5 7=6 8=7 9=8 10=9
    NewPos = 5
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(5) = INT(FuelTotalUsed#): PlayerName$(5) = Phrase$: PlayerScore&(5) = score&: PlayerLevel(5) = RFileNr: PS$(5) = min$ + ":" + sec$: PlayerSeconds&(5) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(6) OR (score& = PlayerScore&(6) AND Bruto& < PlayerSeconds&(6)) OR (score& = PlayerScore&(6) AND Bruto& = PlayerSeconds&(6) AND FuelTotalUsed# < FuelTotal#(6)) THEN '                           Plek 6:  6=P 7=6 8=7 9=8 10=9
    NewPos = 6
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(6) = INT(FuelTotalUsed#): PlayerName$(6) = Phrase$: PlayerScore&(6) = score&: PlayerLevel(6) = RFileNr: PS$(6) = min$ + ":" + sec$: PlayerSeconds&(6) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(7) OR (score& = PlayerScore&(7) AND Bruto& < PlayerSeconds&(7)) OR (score& = PlayerScore&(7) AND Bruto& = PlayerSeconds&(7) AND FuelTotalUsed# < FuelTotal#(7)) THEN '                           Plek 7:  7=P 8=7 9=8 10=9
    NewPos = 7
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    FuelTotal#(8) = FuelTotal#(7): PlayerName$(8) = PlayerName$(7): PlayerScore&(8) = PlayerScore&(7): PlayerLevel(8) = PlayerLevel(7): PlayerSeconds&(8) = PlayerSeconds&(7): PS$(8) = PS$(7)
    ...
    GOSUB invoer
    FuelTotal#(7) = INT(FuelTotalUsed#): PlayerName$(7) = Phrase$: PlayerScore&(7) = score&: PlayerLevel(7) = RFileNr: PS$(7) = min$ + ":" + sec$: PlayerSeconds&(7) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(8) OR (score& = PlayerScore&(8) AND Bruto& < PlayerSeconds&(8)) OR (score& = PlayerScore&(8) AND Bruto& = PlayerSeconds&(8) AND FuelTotalUsed# < FuelTotal#(8)) THEN '                           Plek 8:  8=P 9=8 10=9
    NewPos = 8
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    FuelTotal#(9) = FuelTotal#(8): PlayerName$(9) = PlayerName$(8): PlayerScore&(9) = PlayerScore&(8): PlayerLevel(9) = PlayerLevel(8): PlayerSeconds&(9) = PlayerSeconds&(8): PS$(9) = PS$(8)
    x = 238: y = 150 + (NewPos - 1) * 20: MaxLength = 12: GOSUB TekenLijst
    ...
    GOSUB invoer
    FuelTotal#(8) = INT(FuelTotalUsed#): PlayerName$(8) = Phrase$: PlayerScore&(8) = score&: PlayerLevel(8) = RFileNr: PS$(8) = min$ + ":" + sec$: PlayerSeconds&(8) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(9) OR (score& = PlayerScore&(9) AND Bruto& < PlayerSeconds&(9)) OR (score& = PlayerScore&(9) AND Bruto& = PlayerSeconds&(9) AND FuelTotalUsed# < FuelTotal#(9)) THEN '                           Plek 9:  9=P 10=9
    NewPos = 9
    FuelTotal#(10) = FuelTotal#(9): PlayerName$(10) = PlayerName$(9): PlayerScore&(10) = PlayerScore&(9): PlayerLevel(10) = PlayerLevel(9): PlayerSeconds&(10) = PlayerSeconds&(9): PS$(10) = PS$(9)
    x = 238: y = 150 + (NewPos - 1) * 20: MaxLength = 12: GOSUB TekenLijst
    LINE (x, y)-(584, y + 7), 170, BF
    ...
    GOSUB invoer
    FuelTotal#(9) = INT(FuelTotalUsed#): PlayerName$(9) = Phrase$: PlayerScore&(9) = score&: PlayerLevel(9) = RFileNr: PS$(9) = min$ + ":" + sec$: PlayerSeconds&(9) = Bruto&
    GOTO InvoegenKlaar
END IF
IF score& > PlayerScore&(10) OR (score& = PlayerScore&(10) AND Bruto& < PlayerSeconds&(10)) OR (score& = PlayerScore&(10) AND Bruto& = PlayerSeconds&(10) AND FuelTotalUsed# < FuelTotal#(10)) THEN '                          Plek10:  10=P
    NewPos = 10
    x = 238: y = 150 + (NewPos - 1) * 20: MaxLength = 12: GOSUB TekenLijst
    LINE (x, y)-(584, y + 7), 170, BF
    ...
    GOSUB invoer
    FuelTotal#(10) = INT(FuelTotalUsed#): PlayerName$(10) = Phrase$: PlayerScore&(10) = score&: PlayerLevel(10) = RFileNr: PS$(10) = min$ + ":" + sec$: PlayerSeconds&(10) = Bruto&
    GOTO InvoegenKlaar
END IF
...
w1$ = LTRIM$(STR$(score&))
WHILE LEN(w1$) < 6: w1$ = "0" + w1$: WEND
waarde$ = "SCORE: " + w1$: dx = 400: dy = 200: GOSUB PlaatsTekstCentered
