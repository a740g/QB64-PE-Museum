...
Lst1 = NewControl(3, 230, 30, 350, 200, "", "List Box 1")
Tb1 = NewControl(2, 10, 30, 100, 30, "", "Text Box 1")
Btn1 = NewControl(1, 10, 80, 200, 30, "Btn 1 Here", "")
Tb2 = NewControl(2, 310, 310, 100, 30, "", "Text Box 2")
Btn2 = NewControl(1, 470, 280, 200, 30, "Btn 2 Here", "BTN 2 Label")
' End GUI Controls
