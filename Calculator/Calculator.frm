...
SUB __UI_LoadForm
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_MenuBar, "mnuEdit", 36, 22, 8, 0, 0)
    SetCaption __UI_NewID, "&Edit"
    Control(__UI_NewID).Stretch = False

    __UI_NewID = __UI_NewControl(__UI_Type_MenuBar, "mnuHelp", 41, 22, 44, 0, 0)
    ...
    __UI_NewID = __UI_NewControl(__UI_Type_MenuItem, "mnuCopy", 125, 20, 0, 4, __UI_GetID("mnuEdit"))
    SetCaption __UI_NewID, "Copy   CTRL+C"
    Control(__UI_NewID).Stretch = False

    __UI_NewID = __UI_NewControl(__UI_Type_MenuItem, "mnuPaste", 124, 20, 0, 24, __UI_GetID("mnuEdit"))
    SetCaption __UI_NewID, "Paste   CTRL+V"
    Control(__UI_NewID).Stretch = False

    __UI_NewID = __UI_NewControl(__UI_Type_MenuItem, "mnuAbout", 134, 20, 0, 4, __UI_GetID("mnuHelp"))
