...
piece_color(0) = _RGB32(255, 0, 0)
piece_color(1) = _RGB32(255, 145, 0)
piece_color(2) = _RGB32(255, 200, 211)
piece_color(3) = _RGB32(0, 255, 220)
piece_color(4) = _RGB32(0, 230, 255)
piece_color(5) = _RGB32(0, 170, 10)
piece_color(6) = _RGB32(0, 250, 20)
piece_color(7) = _RGB32(128, 230, 0)
piece_color(8) = _RGB32(80, 150, 0)
piece_color(9) = _RGB32(0, 200, 0)
piece_color(10) = _RGB32(50, 160, 170)
piece_color(11) = _RGB32(50, 110, 175)
piece_color(12) = _RGB32(50, 50, 175)
piece_color(13) = _RGB32(110, 50, 175)
piece_color(14) = _RGB32(210, 0, 255)
piece_color(15) = _RGB32(110, 0, 130)
piece_color(16) = _RGB32(255, 0, 140)
piece_color(17) = _RGB32(170, 0, 100)
...
DO
    ...
    IF redraw THEN
        LINE (0, 0)-(sw * size, sh * size), _RGB32(0, 0, 0), BF
        FOR y = 0 TO sh - 1
            FOR x = 0 TO sw - 1
                IF board(x, y) <> 0 THEN
                    LINE (x * size, y * size)-STEP(size - 2, size - 2), piece_color(board(x, y) - 1), BF
                ELSE
                    LINE (x * size, y * size)-STEP(size - 2, size - 2), _RGB32(50, 50, 50), B
                END IF
            NEXT
        NEXT
