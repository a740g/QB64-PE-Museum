                      ...
                      MADMIX GAME v1.2 - README.TXT file
...
MADMIX GAME is freeware and this means you can redistribute and change it in
your own. Because i want to keep this so, you must redistribute at least the
seven files which originally came in 'madmix.zip' and, of course, it is
forbidden to sell any part of this program.
...
'madmix.zip' comes with:

readme.txt       =     This file
madmix.exe       =     Executable game
madmix.bas       =     Game source
default.pcx      =     Default game graphics
default.txt      =     Default levels
records.txt      =     Best scores
demo.txt         =     Demo game data
