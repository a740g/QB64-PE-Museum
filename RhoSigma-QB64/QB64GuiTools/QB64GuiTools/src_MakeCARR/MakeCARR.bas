...
InputSource$ = StringC$("INIT",_
        ...
        NewTag$("AREA", "on") +_
        NewTag$("TOOLTIP", "Name of the file to convert into a C-Array.|You can type and edit it here or click|the disk symbol for easy selection."))
...
InputTarget$ = StringC$("INIT",_
        ...
        NewTag$("TOOLTIP", "Name of the file to save the QB64 writeback|function to. You can type and edit it here|or click the disk symbol for easy selection."))
...
InputHeader$ = StringC$("INIT",_
        ...
        NewTag$("MAXIMUM", "259") +_
        NewTag$("ALLOWED", pfnChars$) +_
        NewTag$("LABEL", "Header:") +_
        NewTag$("LABELPLACE", "left") +_
        NewTag$("IMAGEFILE", "Aluminium.jpg") +_
        NewTag$("AREA", "on") +_
        NewTag$("DISABLED", "yes") +_
        NewTag$("TOOLTIP", "Name of the file to save the Array & required|C-Stuff to. You can type and edit it here|or click the disk symbol for easy selection."))
GetHeader$ = ButtonC$("INIT",_
        SymbolTag$(GetFileSym$) +_
        NewTag$("LEFT", "434") +_
        NewTag$("TOP", "110") +_
        NewTag$("WIDTH", "31") +_
...
Start$ = ButtonC$("INIT",_
        ...
        NewTag$("AREA", "on") +_
        NewTag$("DISABLED", "yes") +_
        NewTag$("TOOLTIP", "Start converting into C-Array."))
