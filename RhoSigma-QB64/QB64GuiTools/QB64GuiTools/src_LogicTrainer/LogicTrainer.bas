...
'| === LogicTrainer.bas ===                                          |
'|                                                                   |
'| == This is a Mastermind clone. Find 4 out of 6 colors, you have   |
'| == a maximum of 7 tries to achieve the goal.                      |
'|                                                                   |
'+-------------------------------------------------------------------+
...
SetupScreen 496, 496, 0
appCR$ = "A Mastermind clone v1.0, Done by RhoSigma, Roland Heyder"
...
CONST guiReservedPens% = 6 'reserved game colors
'-----
_PALETTECOLOR 250, _RGB32(170, 34, 0): _PALETTECOLOR 251, _RGB32(238, 187, 0)
_PALETTECOLOR 252, _RGB32(0, 136, 0): _PALETTECOLOR 253, _RGB32(0, 119, 187)
_PALETTECOLOR 254, _RGB32(153, 0, 255): _PALETTECOLOR 255, _RGB32(153, 85, 0)
...
'-----
initColorChooser:
InitHoverLayer 0, 26, 24 + ((try% + 1) * 52), 332, 72
C1$ = ButtonC$("INIT",_
...
res$ = GenC$("KILL", C2$): C2$ = ""
res$ = GenC$("KILL", C1$): C1$ = ""
IF chk% = 15 THEN res$ = GenC$("SET", CheckButton$ + NewTag$("DISABLED", "false"))
RETURN
'-----
showCode:
...
FOR c% = 1 TO 4
    SELECT CASE ASC(code$, c%)
        CASE 250: symb$ = RedSymbol$
        CASE 251: symb$ = YellowSymbol$
        CASE 252: symb$ = GreenSymbol$
        CASE 253: symb$ = BlueSymbol$
        CASE 254: symb$ = LilacSymbol$
...
'-----
FUNCTION VersionLogicTrainer$
    VersionLogicTrainer$ = MID$("$VER: LogicTrainer 1.0 (16-Sep-2019) by RhoSigma :END$", 7, 42)
END FUNCTION
'-----
