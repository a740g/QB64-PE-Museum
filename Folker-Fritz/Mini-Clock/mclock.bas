...
IF GFF = 1 THEN CIRCLE (320, 300), 80, 7, -2 * _PI + XCXII, -2 * _PI + XCXII: GFF = 1: XCXX = VAL(MID$(TIME$, 7, 2))
IF GFG = 1 THEN CIRCLE (320, 300), 60, 7, -2 * _PI + XCXHH, -2 * _PI + XCXHH: GFG = 0: XCXY = VAL(MID$(TIME$, 4, 2))
IF GFH = 1 THEN CIRCLE (320, 300), 40, 7, -2 * _PI + XCXAA, -2 * _PI + XCXAA: GFH = 1: XCXZ = VAL(MID$(TIME$, 1, 2))
XCXA = XCXB * XCXC
XCXH = XCXD * XCXF
XCXI = XCXE * XCXG
XCXAA = XCXA
XCXHH = XCXH
XCXII = XCXI
CIRCLE (320, 300), 40, 15, -2 * _PI + XCXA, -2 * _PI + XCXA
CIRCLE (320, 300), 60, 12, -2 * _PI + XCXH, -2 * _PI + XCXH
CIRCLE (320, 300), 80, 8, -2 * _PI + XCXI, -2 * _PI + XCXI
