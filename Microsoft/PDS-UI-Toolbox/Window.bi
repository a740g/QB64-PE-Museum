...
REDIM SHARED GloWindow(0) AS windowType
REDIM SHARED GloButton(0) AS buttonType
REDIM SHARED GloEdit(0) AS EditFieldType
DIM SHARED GloStorage AS WindowStorageType
REDIM SHARED GloWindowStack(0) AS LONG
REDIM SHARED GloBuffer(0, 0) AS STRING
